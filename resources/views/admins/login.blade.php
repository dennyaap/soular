            ...
            <div class="card-body p-md-5">
                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                        ...
                        <input type="text" id="login" class="form-control @error('login') in-invalid @enderror" 
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                        ...
                        <div class="form-outline flex-fill mb-0">
                        <input type="password" id="password" class="form-control @error('password') in-invalid @enderror" name="password"/>
