...
<main style="margin-top: 58px">
    <div class="container pt-4 content">
        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.plots.update', $plot->id) }}">
            @csrf
            @method('PATCH')
            ...
            <div class="mb-3">
                ...
                <div>
                    <label id="imagePreview"
                        style="background-image: url({{ $plot->image ? url('storage/plots/' . $plot->image) : 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRn_hSSv9KQ5fGjyiHARZnDXiOxjWQIU2R-P4kXHlUFRXrybyPUAWW_G-frEjWpuXpuyJ8&usqp=CAU'}});"></label>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" value="{{ old('plot') ?? $plot->name }}" name="name">
